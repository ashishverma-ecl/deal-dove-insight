        ...
        <table className="w-full border-collapse border border-border">
          <thead>
            <tr className="bg-muted">
              ...
              <th className="border border-border p-3 text-left font-semibold w-32">Risk Category</th>
              <th className="border border-border p-3 text-left font-semibold w-48">Screening Criteria</th>
              <th className="border border-border p-3 text-left font-semibold w-24">Threshold</th>
              <th className="border border-border p-3 text-left font-semibold w-28">Performance</th>
              <th className="border border-border p-3 text-left font-semibold w-24">Outcome</th>
